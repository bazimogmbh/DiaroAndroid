...
public class InstaDialog extends DialogFragment implements AspectRatioPreviewAdapter.OnNewSelectedListener, InstaAdapter.BackgroundInstaListener, BrushColorListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.ratio.setOnClickListener(view -> {
            ...
            InstaDialog.this.ratio.setTextColor(ContextCompat.getColor(getContext(),R.color.textColorMain));
            InstaDialog.this.ratio.setBackground(ContextCompat.getDrawable(getContext(),R.drawable.border_bottom));
            InstaDialog.this.background.setTextColor(ContextCompat.getColor(getContext(),R.color.textColorMain_50));
            InstaDialog.this.border.setTextColor(ContextCompat.getColor(getContext(),R.color.textColorMain_50));
        ...
        this.background.setOnClickListener(view -> {
            ...
            InstaDialog.this.instagramPadding.setVisibility(View.GONE);
            InstaDialog.this.background.setTextColor(ContextCompat.getColor(getContext(),R.color.textColorMain));
            InstaDialog.this.background.setBackground(ContextCompat.getDrawable(getContext(),R.drawable.border_bottom));
            InstaDialog.this.ratio.setTextColor(ContextCompat.getColor(getContext(),R.color.textColorMain_50));
            InstaDialog.this.border.setTextColor(ContextCompat.getColor(getContext(),R.color.textColorMain_50));
        ...
        this.border.setOnClickListener(view -> {
            ...
            InstaDialog.this.fixedRatioList.setVisibility(View.GONE);
            InstaDialog.this.rvBackground.setVisibility(View.GONE);
            InstaDialog.this.border.setTextColor(ContextCompat.getColor(getContext(),R.color.textColorMain));
        ...
        inflate.findViewById(R.id.imgClose).setOnClickListener(view -> InstaDialog.this.dismiss());
        inflate.findViewById(R.id.imgSave).setOnClickListener(view -> new SaveInstaView().execute(getBitmapFromView(InstaDialog.this.wrapInstagram)));
