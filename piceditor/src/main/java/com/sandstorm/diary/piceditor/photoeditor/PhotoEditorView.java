...
public class PhotoEditorView extends StickerView {
    ...
    private void init(@Nullable AttributeSet attributeSet) {
        ...
        this.mImgSource.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.grey1));
    ...
    public void setImageSource(final Bitmap bitmap) {
        ...
        if (this.mGLSurfaceView.getImageHandler() != null) {
            ...
            this.mGLSurfaceView.setSurfaceCreatedCallback(() -> PhotoEditorView.this.mGLSurfaceView.setImageBitmap(bitmap));
        }
