package com.sandstorm.diary.piceditor.features.collage.adapter;
...
import com.sandstorm.diary.piceditor.features.collage.layout.slant.NumberSlantLayout;
import com.sandstorm.diary.piceditor.features.collage.layout.straight.NumberStraightLayout;
...
public class PuzzleAdapter extends RecyclerView.Adapter<PuzzleAdapter.PuzzleViewHolder> {
    ...
    public PuzzleViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new PuzzleViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_collage, viewGroup, false));
    }
    ...
    public void onBindViewHolder(PuzzleViewHolder puzzleViewHolder, final int i) {
        ...
        puzzleViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                PuzzleAdapter.this.selectedIndex = i;
