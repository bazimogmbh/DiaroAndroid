...
public class AdjustAdapter extends RecyclerView.Adapter<AdjustAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (this.selectedFilterIndex == i) {
            viewHolder.toolName.setTextColor(ContextCompat.getColor(context, R.color.textPinkSelected));
        } else {
    ...
    private void init() {
        ...
        this.lstAdjusts.add(new AdjustModel(0, this.context.getString(R.string.brightness), "brightness", ContextCompat.getDrawable(this.context, R.drawable.ic_brightness), ContextCompat.getDrawable(this.context, R.drawable.ic_brightness_active), -1.0f, 0.0f, 1.0f));
        this.lstAdjusts.add(new AdjustModel(1, this.context.getString(R.string.contrast), "contrast", ContextCompat.getDrawable(this.context, R.drawable.ic_contract), ContextCompat.getDrawable(this.context, R.drawable.ic_contract_active), 0.1f, 1.0f, 3.0f));
        this.lstAdjusts.add(new AdjustModel(2, this.context.getString(R.string.saturation), "saturation", ContextCompat.getDrawable(this.context, R.drawable.ic_saturation), ContextCompat.getDrawable(this.context, R.drawable.ic_saturation_active), 0.0f, 1.0f, 3.0f));
        this.lstAdjusts.add(new AdjustModel(3, this.context.getString(R.string.sharpen), "sharpen", ContextCompat.getDrawable(this.context, R.drawable.ic_sharpen), ContextCompat.getDrawable(this.context, R.drawable.ic_sharpen_active), -1.0f, 0.0f, 10.0f));
    }
