 ...
 * {ExpandableListView} widget. The top-level {@link Cursor} (that is
 ...
 * will not work.
 */
public abstract class MyCursorTreeAdapter extends BaseExpandableListAdapter {
    /**
...
//        AppLog.d("cursorHelper: " + cursorHelper + ", groupPosition: " + groupPosition + ", requestCursor: " + requestCursor);

        if (cursorHelper == null && requestCursor) {
